...
import { Sun, Cloud, Moon, Star, ChevronDown, ChevronRight, Plus, CheckCircle2, Circle, X } from 'lucide-react';
...
const slotConfig: Record<TimeSlot, { icon: typeof Sun; color: string; bgColor: string; borderColor: string; timeRange: string }> = {
  morning: {
    icon: Sun,
        ...
        <div className="bg-white dark:bg-gray-900 p-3 space-y-2">
          {tasks.length === 0 ? (
            <div className="text-center py-4">
              <Icon className={`w-6 h-6 ${config.color} opacity-30 mx-auto mb-1`} />
              ...
              return (
                <div
                  ...
                  className={`flex items-center gap-3 p-3 rounded-lg border border-gray-200 dark:border-gray-700 ${
                    isCompleted ? 'opacity-60 bg-gray-50 dark:bg-gray-800/50' : 'bg-white dark:bg-gray-800'
                  }`}
                >
                  {/* Priority indicator */}
