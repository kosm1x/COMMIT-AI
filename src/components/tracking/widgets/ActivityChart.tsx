    ...
    <div className="glass-card p-6 border border-white/40 dark:border-white/10">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
              ...
              <div className="text-sm text-text-secondary">Ideas</div>
            </div>
            <div className="text-center p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
              <div className="text-2xl font-bold text-orange-600 dark:text-orange-400">
                {dailyActivity[0]?.mindMaps || 0}
              </div>
              <div className="text-sm text-text-secondary">Mind Maps</div>
            </div>
            <div className="text-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
              <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">
                {formatTime(dailyActivity[0]?.timeSpent || 0)}
              </div>
              <div className="text-sm text-text-secondary">Time Active</div>
            </div>
          </div>
        </div>
      ) : viewMode === 'weekly' ? (
                  ...
                  <div className="space-y-1">
                    <div className="relative h-20 bg-gray-100 dark:bg-gray-800 rounded-lg overflow-hidden">
                      ...
                      <div
                        ...
                        title={`${day.mindMaps} mind maps`}
                      />
                    </div>
                    <div className="text-center text-xs text-text-secondary">
                      <div>I: {day.ideas}</div>
                      <div>M: {day.mindMaps}</div>
            ...
            {dailyActivity.map((day, index) => {
              ...
              return (
                <div
                  ...
                  title={`${day.date.toLocaleDateString()}: ${day.ideas} ideas, ${day.mindMaps} mind maps, ${formatTime(day.timeSpent)} active`}
                >
      ...
      <div className="mt-6 pt-4 border-t border-border-secondary">
        <div className="grid grid-cols-3 gap-2">
          <div>
            <div className="text-xs text-text-tertiary mb-1">Ideas</div>
          ...
          <div>
            <div className="text-xs text-text-tertiary mb-1">Mind Maps</div>
            <div className="w-full bg-gray-200 dark:bg-gray-800 rounded-full h-1.5 overflow-hidden">
              <div
          ...
          <div>
            <div className="text-xs text-text-tertiary mb-1">Time</div>
            <div className="w-full bg-gray-200 dark:bg-gray-800 rounded-full h-1.5 overflow-hidden">
              <div
