      ...
      <div className="flex-1 p-4 pb-24">
        <div className="text-center py-2 mb-4">
          <p className="text-sm text-gray-400 dark:text-gray-500">
            {t("emptyState.map") ||
              "Pick a challenge and let AI help you map it."}
          </p>
        </div>
        <div className="h-[calc(100vh-13rem)] bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 overflow-hidden">
          {viewMode === "kanban" ? (
            <KanbanView
              initialScrollTo={scrollTo}
              initialSelectItem={selectItem}
            />
          ) : (
            <Suspense
              fallback={
