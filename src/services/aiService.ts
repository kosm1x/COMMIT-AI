...
function generateMockObjectives(_goalTitle: string, language: 'en' | 'es' | 'zh' = 'en'): SuggestedObjective[] {
  const mockData: Record<'en' | 'es' | 'zh', SuggestedObjective[]> = {
    en: [
      {
        title: 'Define success metrics and KPIs',
        description: 'Establish clear, measurable indicators to track progress toward this goal.',
        priority: 'high',
        reasoning: 'Without metrics, you cannot measure progress or know when the goal is achieved.',
      },
      {
        title: 'Create detailed action plan',
        description: 'Break down the goal into specific tasks with timelines and responsibilities.',
        priority: 'high',
        reasoning: 'A structured plan turns aspirations into executable steps.',
      },
      {
        title: 'Identify required resources',
        description: 'List all tools, budget, people, and information needed to achieve the goal.',
        priority: 'medium',
        reasoning: 'Resource planning prevents roadblocks and ensures smooth execution.',
      },
    ],
    es: [
      {
        title: 'Definir métricas de éxito y KPIs',
        description: 'Establecer indicadores claros y medibles para rastrear el progreso hacia este objetivo.',
        priority: 'high',
        reasoning: 'Sin métricas, no se puede medir el progreso ni saber cuándo se logra el objetivo.',
      },
      {
        title: 'Crear plan de acción detallado',
        description: 'Dividir el objetivo en tareas específicas con cronogramas y responsabilidades.',
        priority: 'high',
        reasoning: 'Un plan estructurado convierte las aspiraciones en pasos ejecutables.',
      },
      {
        title: 'Identificar recursos necesarios',
        description: 'Listar todas las herramientas, presupuesto, personas e información necesaria.',
        priority: 'medium',
        reasoning: 'La planificación de recursos previene obstáculos y asegura una ejecución fluida.',
      },
    ],
    zh: [
      {
...
function generateMockTasks(_objectiveTitle: string, language: 'en' | 'es' | 'zh' = 'en'): SuggestedTask[] {
  const mockData: Record<'en' | 'es' | 'zh', SuggestedTask[]> = {
    en: [
      {
        title: 'Research and document requirements',
        description: 'Gather all necessary information and create a detailed requirements document.',
        priority: 'high',
        reasoning: 'Understanding requirements is the foundation for successful execution.',
      },
      {
        title: 'Create initial implementation plan',
        description: 'Break down the objective into specific steps with estimated timelines.',
        priority: 'high',
        reasoning: 'A clear plan prevents wasted effort and keeps work focused.',
      },
      {
        title: 'Set up necessary tools and resources',
        description: 'Identify and prepare all tools, accounts, and resources needed for the work.',
        priority: 'medium',
        reasoning: 'Having resources ready eliminates delays during implementation.',
      },
    ],
    es: [
      {
        title: 'Investigar y documentar requisitos',
        description: 'Reunir toda la información necesaria y crear un documento detallado de requisitos.',
        priority: 'high',
        reasoning: 'Comprender los requisitos es la base para una ejecución exitosa.',
      },
      {
        title: 'Crear plan de implementación inicial',
        description: 'Dividir el objetivo en pasos específicos con cronogramas estimados.',
        priority: 'high',
        reasoning: 'Un plan claro previene el esfuerzo desperdiciado y mantiene el trabajo enfocado.',
      },
      {
        title: 'Configurar herramientas y recursos necesarios',
        description: 'Identificar y preparar todas las herramientas, cuentas y recursos necesarios para el trabajo.',
        priority: 'medium',
        reasoning: 'Tener recursos listos elimina retrasos durante la implementación.',
      },
    ],
    zh: [
      {
